      ...
      {flag ? arrayExps.map((experience, index) => (
        <div className={styles.boxPageQuest} key={experience.id + index}>
          <div className={styles.boxInputs1}>
            <InputText text={"Ano de início"} flagInput={flagInput} setFlagInput={setFlagInput} 
            id={experience.id} categ={"inicio"}/>

            <InputText text={"Ano de termino"} flagInput={flagInput} setFlagInput={setFlagInput} 
            id={experience.id} categ={"fim"}/>
          </div>

          <div className={styles.boxInputs2}>
            <InputText text={"Profissão"} flagInput={flagInput} setFlagInput={setFlagInput} 
            id={experience.id} categ={"profissao"}/>

            <InputText text={"Empresa"} flagInput={flagInput} setFlagInput={setFlagInput} 
            id={experience.id} categ={"empresa"}/>
          </div>

          <div className={styles.containerTextarea}>
            <Textarea text={"Sobre a experiência:"} rowsText={4} flagInput={flagInput} 
              setFlagInput={setFlagInput} id={experience.id} categ={"sobreExp"}/>
